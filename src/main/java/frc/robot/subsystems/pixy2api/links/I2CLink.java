package frc.robot.subsystems.pixy2api.links;
...
public class I2CLink implements Link { //WAS implements Link
	private final static int PIXY_I2C_DEFAULT_ADDR = 0x69;
