...
public class Motors {
     ...
     //DriveTrain PID
     public static CANPIDController rightFrontPID = rightFront.getPIDController();
     public static CANPIDController leftFrontPID  = leftFront.getPIDController();
     public static CANPIDController rightBackPID  = rightBack.getPIDController();
     public static CANPIDController leftBackPID   = leftBack.getPIDController();
